...
TARGETS = $(LIBUSBIP_TARGET) $(RPCSERVER_TARGET) $(RPCCLIENT_TARGET) $(SEARCHIDEV_TARGET)
OBJECTS = $(LIBUSBIP_OBJECTS) $(RPCSERVER_OBJECTS) $(RPCCLIENT_OBJECTS) $(SEARCHIDEV_OBJECTS)
...
clean:
	$(RM) $(LIBUSBIP_TARGET) $(RPCSERVER_TARGET) $(RPCCLIENT_TARGET) $(SEARCHIDEV_TARGET) libusbip/*.o examples/*.o include/tpl/*.o
